                ...
                <ul class="nav nav-pills ml-auto p-2">
                	...
                	if ($grupos!=false) {
                		...
                		foreach ($grupos->result() as $grupo) {
                			...
                			?>
                			<li class="nav-item">
                				<a class="nav-link <?= $active ?> btn-tab" href="#tab_<?= ++$conta ?>" data-toggle="tab"><?= $grupo->nombre ?></a>
                			</li>
                			<?
                		}
                	}
                				...
                				<table class="table table-bordered table-hover table-striped table-responsive">
                							...
                							if ($productos!=false) {
                								foreach ($productos->result() as $producto) {
                									if ($producto->id_grupo == $grupo->id_grupo) {
	                									?>
	                									<th class="bg-secondary" style="width: 400px;"><?= $producto->nombre ?></th>
	                									<?
                									}
                								}
                							}
                					...
                					<tbody>
                						...
                						if ($productos!=false) {
                							?>
	                						<tr>
	                							<th class="txt-centrado bg-secondary" colspan="<?= count($productos->result()) + 1 ?>">Etiquetados LATAM</th>
	                						</tr>
                							...
                							<tr>
                								...
                								foreach ($productos->result() as $producto) {
		                							if ($producto->id_grupo == $grupo->id_grupo) {
		                								$IsraelLabel = new Etiquetado_israel($producto->sodio, $producto->azucaresa, $producto->acidosgs, $this->tipo);
			                							?>
			                							<td class="txt-centrado">
			                								<?
